...
internal class SoknadModelTest {
    ...
    fun serde() {
        ...
        assertEquals("selvbetjening-ui:02c77cfce65041d5261115dcc94179dffe04cae1", soeknad.imageTag)
