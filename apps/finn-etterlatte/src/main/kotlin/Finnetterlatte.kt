...
internal class FinnEtterlatte(
    rapidsConnection: RapidsConnection,
    private val pdl: FinnEtterlatteForPerson
) : River.PacketListener {
    private val logger = LoggerFactory.getLogger(FinnEtterlatte::class.java)
