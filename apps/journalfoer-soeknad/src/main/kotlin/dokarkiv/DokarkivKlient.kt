...
interface Dokarkiv {
    suspend fun journalfoerDok(request: JournalpostRequest, forsoekFerdigstill: Boolean): DokarkivResponse
}
...
class DokarkivKlient(private val client: HttpClient, private val baseUrl: String) : Dokarkiv {
    ...
    override suspend fun journalfoerDok(request: JournalpostRequest, forsoekFerdigstill: Boolean): DokarkivResponse {
        return try {
