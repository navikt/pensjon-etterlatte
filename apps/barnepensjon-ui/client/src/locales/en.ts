...
const forside = {
    ...
    'omYtelsene.papirsoeknad.tekst': 'a printed form.',
    'omYtelsene.lenkeGjenlevende.href':
        'https://www.nav.no/en/home/benefits-and-services/relatert-informasjon/benefits-for-surviving-spouse',
    'omYtelsene.lenkeGjenlevende.tekst': 'Read more about survivor’s pension',
    'omYtelsene.lenkeOvergangsstoenad.href': 'https://www.nav.no/overgangsstonad-gjenlevende',
    'omYtelsene.lenkeOvergangsstoenad.tekst': 'Read more about transitional benefit',
    'barnepensjon.tittel': 'You can also apply for a children’s pension',
    ...
    'barnepensjon.tekst': 'Read more about children’s pension',
    'uthentingAvInfo.tittel': 'We gather the information we need',
    ...
    'uthentingAvInfo.lenke1.tekst': 'Read more about how we process your personal data',
    ...
    'uthentingAvInfo.lenke2.tekst': 'Read more about data protection and security on the nav.no website',
    'samtykke.tittel': 'We trust you',
    'samtykke.innhold':
    ...
    'samtykke.lenke.tekst': 'my obligations on nav.no',
    'samtykke.lenke.href':
