...
// prettier-ignore
const forside = {
    'tittel': 'Søk om attlevandepensjon eller overgangsstønad',
    'hei': 'Hei, {{navn}}',
    ...
    'omYtelsene.lenkeGjenlevende.tekst': 'Meir om attlevandepensjon',
    'omYtelsene.lenkeOvergangsstoenad.href': 'https://www.nav.no/overgangsstonad-gjenlevende',
    'omYtelsene.lenkeOvergangsstoenad.tekst': 'Meir om overgangsstønad',
    ...
    'barnepensjon.tekst': 'Meir om barnepensjon',
    ...
    'uthentingAvInfo.innholdListe.li1': '<strong>Personinformasjon</strong> frå Folkeregisteret',
    'uthentingAvInfo.innholdListe.li2': '<strong>Inntektsinformasjon</strong> frå Skatteetaten',
    'uthentingAvInfo.innholdListe.li3':
        'Opplysingar om <strong>arbeidsforhold</strong> frå Arbeidsgivar- og arbeidstakarregisteret',
    'uthentingAvInfo.innholdListe.li4': 'Opplysingar om <strong>anna støtte frå NAV</strong>',
    ...
    'uthentingAvInfo.lenke1.tekst': 'Slik behandlar vi personopplysingane dine',
    ...
    'uthentingAvInfo.lenke2.tekst': 'Om personvern og sikkerheit på nav.no',
