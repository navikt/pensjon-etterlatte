...
const error = {
    ...
    'deceasedParentOne.required': 'Du mangler å fylle inn informasjon om den første forelderen',
    'deceasedParentTwo.required': 'Du mangler å fylle inn informasjon om den andre forelderen',
}
