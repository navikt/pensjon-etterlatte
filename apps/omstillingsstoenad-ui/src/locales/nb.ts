export default {
    ...
    'dinSituasjon.jobbStatus.hvorfor': 'Vi trenger å vite hva du gjør, slik at vi kan gi deg informasjon og oppfølging som passer din situasjon.',
    ...
    'dinSituasjon.selvstendig.as.tittel': 'Om næringen (AS)',
    'dinSituasjon.selvstendig.enk.tittel': 'Om næringen (ENK)',
    'dinSituasjon.selvstendig.hvaHeterNaeringen': 'Hva heter næringen?',
    'dinSituasjon.selvstendig.hvaHeterNaeringen.beskrivelse': 'Skriv navnet på foretaket eller bedriften.',
    'dinSituasjon.selvstendig.grunnTilSpoersmål': 'Grunnen til at vi spør om dette',
    'dinSituasjon.selvstendig.grunnTilSpoersmål.hvorfor': 'Vi trenger å få vite hva du planlegger å gjøre fremover. Dette hjelper oss med å gi deg relevant informasjon og oppfølging som passer for deg.',
    ...
    'dinSituasjon.selvstendig.arbeidsmengde.svar': 'Fyll ut arbeidsmengden din',
    'dinSituasjon.selvstendig.arbeidsmengde.type': 'Type arbeidsmengde',
    'dinSituasjon.selvstendig.arbeidsmengde.enk': 'Hvor mye jobber du i eget firma?',
    'dinSituasjon.selvstendig.arbeidsmengde.beskrivelse': 'Hvis det varierer fra måned til måned, anslår du hvor mye du regner med å jobbe fremover. Dette gjelder også hvis du er sykemeldt.',
    ...
    'dinSituasjon.arbeidsforhold.ansettelsesforhold.fast.beskrivelse': 'Oppgi stillingsprosenten du vanligvis har. Dette gjelder også hvis du er sykemeldt.',
    'dinSituasjon.arbeidsforhold.ansettelsesforhold.midlertidig.beskrivelse': 'Oppgi arbeidsmengden du vanligvis har. Dette gjelder også hvis du er sykemeldt.',
    ...
    'dinSituasjon.arbeidsforhold.sagtOppEllerRedusert.hvorfor': 'Vi trenger å få vite hva du planlegger å gjøre fremover. Dette hjelper oss med å gi deg relevant informasjon og oppfølging som passer for deg.',
    'dinSituasjon.etablererVirksomhet.tittel': 'Om virksomheten',
    'dinSituasjon.etablererVirksomhet.orgnr': 'Organisasjonsnummer',
    'dinSituasjon.etablererVirksomhet.hvaHeterVirksomheten': 'Hva heter virksomheten?',
    'dinSituasjon.etablererVirksomhet.forretningsplan.svar': 'Har du en forretningsplan?',
    'dinSituasjon.etablererVirksomhet.forretningsplan.samarbeidMedNAV.svar': 'Er dette i samarbeid med NAV for at du skal bli selvforsørget?',
    'dinSituasjon.tilbudOmJobb.tittel': 'Om arbeidsforholdet ditt',
    'dinSituasjon.tilbudOmJobb.arbeidssted': 'Navn på nytt arbeidssted',
    'dinSituasjon.tilbudOmJobb.ansettelsesforhold': 'Hva slags type ansettelsesforhold skal du ha?',
    'dinSituasjon.tilbudOmJobb.ansettelsesdato': 'Når skal du begynne å jobbe?',
    'dinSituasjon.tilbudOmJobb.ansettelsesdato.beskrivelse': 'Ansettelsesdato',
    'dinSituasjon.tilbudOmJobb.ansettelsesforhold.tittel': 'Hvor mye skal du jobbe?',
    'dinSituasjon.tilbudOmJobb.ansettelsesforhold.beskrivelse.fast': 'Oppgi stillingsprosenten du har fått. Dette gjelder også hvis du er sykemeldt.',
    'dinSituasjon.tilbudOmJobb.ansettelsesforhold.beskrivelse.midlertidig': 'Oppgi hva som står i arbeidskontrakten. Du må også oppgi dette hvis du er sykemeldt.',
    'dinSituasjon.tilbudOmJobb.arbeidsmengde.svar.fast': 'Stillingsprosent',
    'dinSituasjon.tilbudOmJobb.arbeidsmengde.svar': 'Arbeidsmengde',
    ...
    'inntektenDin.undertittel': 'Inntekt, pensjon og andre utbetalinger',
    'inntektenDin.ingress': 'Hvor mye du kan få i omstillingsstønad avhenger av arbeidsinntekten din. Vi beregner forventet inntekt både på grunnlag av arbeidssituasjonen og inntekten din. Inntekt henter vi fra Skatteetaten.',
    'inntektenDin.inntektstyper': 'Hvilken type inntekt har du?',
    'inntektenDin.loennsinntekt.tittel': 'Lønnsinntekt',
    'inntektenDin.loennsinntekt.ingress': 'Har du flere arbeidsforhold eller inntekt fra utlandet, skal du ta med dette i arbeidsinntekten du oppgir. Arbeidsinntekten oppgir du i norske kroner.',
    'inntektenDin.loennsinntekt.info': 'Hvis inntekten din endrer seg etter du har sendt inn søknaden, må du melde fra om endringen til oss.',
    'inntektenDin.loennsinntekt.arbeidsinntektAaretFoer.tittel': 'Arbeidsinntekten din året før dødsfallet',
    'inntektenDin.loennsinntekt.arbeidsinntektAaretFoer': 'Oppgi brutto arbeidsinntekt i året før dødsfallet',
    'inntektenDin.loennsinntekt.arbeidsinntektAaretFoer.beskrivelse': 'Samlet arbeidsinntekt fra januar til desember',
    'inntektenDin.loennsinntekt.arbeidsinntektAaretFoer.hvorfor': 'Brutto arbeidsinntekt er inntekten din før skatt.',
    ...
    'inntektenDin.loennsinntekt.forventerEndringAvInntekt.svar': 'Regner du med at inntekten din endrer seg fremover i tid?',
    ...
    'inntektenDin.naeringsinntekt.arbeidsinntektAaretFoer.beskrivelse': 'Samlet næringsinntekt før skatt fra januar til desember',
    'inntektenDin.naeringsinntekt.arbeidsinntektAaretFoer.hvorfor': 'Brutto arbeidsinntekt er inntekten din før skatt.',
    'inntektenDin.naeringsinntekt.arbeidsinntektIAar.tittel': 'Næringsinntekten din i år',
    'inntektenDin.naeringsinntekt.arbeidsinntektIAar.tilDoedsfall': 'Anslå brutto næringsinntekt frem til måneden før dødsfallet',
    'inntektenDin.naeringsinntekt.arbeidsinntektIAar.tilDoedsfall.beskrivelse': 'Samlet næringsinntekt før skatt fra  januar til måneden før dødsfallet',
    'inntektenDin.naeringsinntekt.arbeidsinntektIAar.etterDoedsfall': 'Anslå brutto næringsinntekt du forventer fremover',
    'inntektenDin.naeringsinntekt.arbeidsinntektIAar.etterDoedsfall.beskrivelse': 'Samlet næringsinntekt før skatt fra samme måneden som dødsfallet til desember',
    'inntektenDin.naeringsinntekt.forventerEndringAvInntekt.svar': 'Regner du med at inntekten din endrer seg fremover i tid?',
    ...
    'inntektenDin.pensjonEllerUfoere.pensjonsUtbetaler': 'Hvem utbetaler pensjonen din? ',
    'inntektenDin.pensjonEllerUfoere.pensjonsUtbetaler.beskrivelse': 'Eksempler: Statens pensjonskasse, Oslo pensjonsforsikring',
    'inntektenDin.pensjonEllerUfoere.pensjonsUtbetaler.hvorfor': ' Vi må vite om utbetalingen får betydning for rett til omstillingsstønad',
    ...
    'inntektenDin.annenInntekt.inntektEllerUtbetaling': 'Velg hvilke andre inntekter eller utbetalinger du har',
    'inntektenDin.annenInntekt.beloep': 'Oppgi inntekt eller ytelser i kroner',
    'inntektenDin.annenInntekt.forventerEndringAvInntekt.svar': 'Regner du med at inntekten din endrer seg fremover i tid?',
    ...
    'inntektenDin.ytelserNAV.svar': 'Har du søkt ytelser fra NAV som du ikke har fått svar på?',
    ...
    'inntektenDin.ytelserAndre.pensjonsordning.beskrivelse': 'Eksempler: Statens pensjonskasse, Oslo pensjonsforsikring',
    ...
    'sagtOppEllerRedusert.oppsagt': 'Ja, jeg har sagt opp jobben eller tatt frivillig permisjon (ikke foreldrepermisjon)',
    ...
    'jobbStatus.selvstendig.enk': 'Jeg er selvstendig næringsdrivende eller frilanser med enkeltpersonforetak',
    'jobbStatus.selvstendig.as': 'Jeg er selvstendig næringsdrivende og ansatt i mitt eget aksjeselskap (AS)',
    ...
    'endringAvInntekt.loennsoekning': 'Lønnsoekning',
