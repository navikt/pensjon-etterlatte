export default {
    ...
    visAlleSteg: 'Vis alle steg',
    skjulAlleSteg: 'Skjul alle steg',
    ...
    'forside.startSoeknad': 'Start utfyllingen',
    ...
    'forside.innsamlingAvInfo.innholdListe.li1':
        'identifisere og kommunisere med deg som søker eller er representant for søker',
    'forside.innsamlingAvInfo.innholdListe.li2': 'behandle søknaden din',
    'forside.innsamlingAvInfo.innholdListe.li3': 'betale ut ytelsen',
    ...
    'forside.uthentingAvInfo.innholdListe.li1':
        'personopplysninger fra Folkeregisteret (personnummer, adresse, statsborgerskap, sivilstand)',
    ...
    'forside.personvern.tredjeperson.li3': 'hvorvidt man har hatt eller har felles barn med søker',
    'forside.personvern.tredjeperson.li4': 'sivilstand',
    'forside.utleveringAvOpplysninger.tittel': 'Utlevering av dine opplysninger',
    'forside.utleveringAvOpplysninger.innhold':
        'I forbindelse med behandling av søknad om omstillingsstønad utleverer vi enkelte personopplysninger til andre mottakere. Utlevering skjer som oftest i forbindelse med innhenting av opplysninger for å bevise at Nav har lov til å samle inn informasjon om identifiserte enkeltpersoner. For søkere med tilknytning til utland kan det også utleveres informasjon til andre lands trygdemyndigheter.',
    'forside.lagringstid.tittel': 'Hvor lenge lagres dine opplysninger',
    ...
    'forside.automatiskbehandling.innhold2.del1':
        'Ved noen anledninger vil det gjøres en automatisk behandling i saken. Ved en løpende ytelse som bruker ',
    'forside.automatiskbehandling.innhold2.del2':
        ' som beregningsgrunnlag, slik som i omstillingsstønad, vil systemet automatisk endre din utbetaling basert på endringer i grunnbeløpet. Dette er for å sikre at utbetaling av ytelser foregår effektivt.',
    'forside.automatiskbehandling.innhold2.lenke.tekst': 'grunnbeløpet i folketrygden',
    ...
    'forside.automatiskbehandling.innhold4': 'Følgende opplysninger benyttes for å gjennomføre grunnbeløpsregulering:',
    'forside.automatiskbehandling.innholdListe.li1': 'personnummer',
    'forside.automatiskbehandling.innholdListe.li2': 'saks-ID',
    'forside.automatiskbehandling.innholdListe.li3': 'type ytelse',
    'forside.automatiskbehandling.innholdListe.li4': 'gjeldende vedtak',
    ...
    'forside.harSoektOms.tittel': 'Du har allerede en aktiv søknad hos oss',
    'forside.harSoektOms.avsnitt':
        'Vi ser at du nylig har sendt inn denne søknaden. Dersom du sender inn søknaden på nytt, vil behandlingen ta lenger tid. Ønsker du å opplyse om endringer eller noe nytt kan du gjøre følgende:',
    'forside.harSoektOms.innhold.li1.lenke.href': 'https://www.nav.no/kontonummer',
    ...
    'merOmSituasjonenDin.utdanning.aktivitetsplan.svar': 'Har du en aktivitetsplan i samarbeid med Nav?',
    ...
    'merOmSituasjonenDin.tilbudOmJobb.aktivitetsplan.svar': 'Har du en aktivitetsplan i samarbeid med Nav?',
    ...
    'inntektenDin.alderspensjonOgOmstillingsstoenad.p2.lenke.tekst': 'søke om alderspensjon.',
    'inntektenDin.alderspensjonOgOmstillingsstoenad.p2.lenke.href': 'https://www.nav.no/alderspensjon#soke',
    'inntektenDin.alderspensjonOgOmstillingsstoenad.p3': 'Hvis du er født før 1963, kan du ha rett til',
    'inntektenDin.alderspensjonOgOmstillingsstoenad.p3.lenke.tekst': 'gjenlevenderett i alderspensjonen.',
    ...
    'feil.inntektFremTilDoedsfallet.naeringsinntekt.erNaeringsinntektOpptjentJevnt.valg.required':
        'Svar på om arbeidet er jevnt opptjent gjennom året eller ikke',
    ...
    'feil.inntektFremTilDoedsfallet.naeringsinntekt.erNaeringsinntektOpptjentJevnt.beskrivelse.required':
        'Beskriv variasjonene i inntekten',
    ...
    'feil.inntektFremTilDoedsfallet.afpInntekt.tjenesteordning.required':
        'Du må fylle ut hvilken tjenestepensjonordning du får AFP fra',
    ...
    'feil.forventetInntektIAar.andreInntekter.beskrivelse.required': 'Beskriv hva slags inntekt det gjelder',
    ...
    'feil.forventetInntektIAar.noeSomKanPaavirkeInntekten.valg.required':
        'Svar på om du vet om noe som kan påvirke inntekten din.',
    ...
    'feil.forventetInntektIAar.noeSomKanPaavirkeInntekten.grunnTilPaavirkelseAvInntekt.required':
        'Svar på hvorfor inntekten endrer seg',
    'inntektenDin.forventetInntektIAar.noeSomKanPaavirkeInntekten.beskrivelse': 'Beskriv endringen',
    'feil.forventetInntektIAar.noeSomKanPaavirkeInntekten.beskrivelse.required': 'Beskriv endringen',
    ...
    'feil.forventetInntektTilNesteAar.andreInntekter.beskrivelse.required': 'Beskriv hva slags inntekt det gjelder',
    ...
    'feil.forventetInntektTilNesteAar.noeSomKanPaavirkeInntekten.beskrivelse.required': 'Beskriv endringen',
    ...
    'inntektenDin.pensjonEllerUfoere.utland.beloep': 'Oppgi brutto månedsbeløp utbetalt i pensjon fra utlandet',
    ...
    'inntektenDin.ytelserAndre.tittel': 'Søknad om ytelser fra andre',
    ...
    'omDenAvdoede.ukjentFoedselsnummerInfo':
        'Behandlingen av søknaden tar lengre tid når du ikke oppgir fødselsnummeret.',
    ...
    'omBarn.ukjentFoedselsnummerInfo': 'Behandlingen av søknaden tar lengre tid når du ikke oppgir fødselsnummeret.',
    ...
    'omBarn.barnepensjon.ikkeSoekt': 'Søker ikke om barnepensjon',
    'omBarn.barnepensjon.soeker': 'Jeg søker om barnepensjon for dette barnet',
    ...
    'avbrytModal.spoersmaal': 'Vil du fortsette senere?',
    'avbrytModal.svarNei': 'Nei, jeg vil fortsette nå',
    'avbrytModal.svarJa': 'Ja, fortsett senere',
    ...
    'avdoede.relasjon.gift': 'Gift eller partner',
    ...
    'inntekt.ytelser': 'Ytelser fra Nav',
    'inntekt.annen': 'Ingen inntekt eller annen utbetaling',
    'inntekt.norge': 'Norge',
    ...
    'nySivilstatus.enke': 'Enke eller enkemann',
    'nySivilstatus.ekteskap': 'Gift eller partner',
    ...
    'felles.ikkeSensitiveOpplysninger': 'Ikke oppgi sensitive personopplysninger.',
    ...
    'feil.utdanning.aktivitetsplan.svar.required': 'Oppgi om du har en aktivitetsplan i samarbeid med Nav',
    ...
    'feil.tilbudOmJobb.aktivitetsplan.svar.required': 'Oppgi om du har en aktivitetsplan i samarbeid med Nav',
    ...
    'feil.loennsinntekt.norge.inntektNesteAar.aarsinntekt.required': 'Oppgi forventet brutto årsinntekt til neste år',
    ...
    'feil.loennsinntekt.utland.inntektNesteAar.aarsinntekt.required': 'Oppgi forventet brutto årsinntekt til neste år',
    ...
    'feil.naeringsinntekt.norge.inntektIFjor.tilDoedsfall.required': 'Oppgi brutto næringsinntekt frem til dødsfallet',
    'feil.naeringsinntekt.utland.inntektIFjor.tilDoedsfall.required': 'Oppgi brutto næringsinntekt frem til dødsfallet',
    'feil.naeringsinntekt.norge.inntektIFjor.aarsinntekt.required': 'Oppgi brutto årsinntekt i fjor',
    'feil.naeringsinntekt.utland.arbeidsinntektDoedsfallsaaret.required': 'Oppgi brutto årsinntekt i dødsfallsåret',
    'feil.naeringsinntekt.norge.arbeidsinntektDoedsfallsaaret.required': 'Oppgi brutto årsinntekt i dødsfallsåret',
    'feil.naeringsinntekt.norge.inntektIAar.tilDoedsfall.required': 'Oppgi brutto næringsinntekt frem til dødsfallet',
    'feil.naeringsinntekt.norge.inntektNesteAar.aarsinntekt.required': 'Oppgi forventet brutto årsinntekt til neste år',
    'feil.naeringsinntekt.utland.inntektIFjor.aarsinntekt.required': 'Oppgi brutto årsinntekt i fjor',
    'feil.naeringsinntekt.utland.inntektIAar.tilDoedsfall.required': 'Oppgi brutto næringsinntekt frem til dødsfallet',
    'feil.naeringsinntekt.utland.inntektNesteAar.aarsinntekt.required':
        'Oppgi forventet brutto årsinntekt til neste år',
    ...
    'feil.naeringsinntekt.norge.jevntOpptjentNaeringsinntekt.svar.required':
        'Du må velge om arbeidet er jevnt opptjent gjennom året eller ikke',
    ...
    'feil.naeringsinntekt.norge.inntektIAar.aarsinntekt.required': 'Oppgi forventet brutto årsinntekt i år',
    ...
    'feil.naeringsinntekt.utland.jevntOpptjentNaeringsinntekt.beskrivelse.required':
        'Gi en kort beskrivelse av variasjonene i inntekten',
    'feil.naeringsinntekt.utland.inntektIAar.aarsinntekt.required': 'Oppgi forventet brutto årsinntekt i år',
    ...
    'feil.pensjonEllerUfoere.utland.valuta.required': 'Velg valuta',
    'feil.inntektViaYtelserFraNAV.ytelser.required': 'Kryss av på hvilke inntekter og utbetalinger du har',
    'feil.inntektViaYtelserFraNAV.aktivitetsplan.svar.required': 'Oppgi om du har en aktivitetsplan',
    ...
    'feil.ingenInntekt.beskrivelse.required': 'Beskrivelse av hvilken type utbetaling du har må besvares',
    ...
    'readmore.tittel.hvorfor.spoer.vi': 'Hvorfor spør vi om dette?',
}
