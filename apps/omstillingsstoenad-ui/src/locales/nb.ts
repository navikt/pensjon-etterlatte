export default {
    ...
    'forside.harSoektOms.avsnitt':
        'Vi ser at du nylig har sendt inn denne søknaden. Dersom du sender inn søknaden på nytt, kan behandlingen ta lenger tid. Ønsker du å opplyse om endringer eller noe nytt kan du gjøre følgende:',
    'forside.harSoektOms.innhold.li1.del1': 'Her kan du sjekke eller',
    'forside.harSoektOms.innhold.li1.del2': 'du har registrert hos Nav.',
    ...
    'forside.harSoektOms.innhold.li2.lenke.tekst': 'melde fra om frivillig skattetrekk',
    'forside.harSoektOms.innhold.li3': 'Her kan du',
    'forside.harSoektOms.innhold.li3.lenke.href': 'https://www.nav.no/start/ettersend-soknad-omstillingstonad',
    'forside.harSoektOms.innhold.li3.lenke.tekst': 'ettersende dokumentasjon',
    'forside.harSoektOms.innhold.li4': 'Er det noe annet du ønsker å melde inn kan du',
