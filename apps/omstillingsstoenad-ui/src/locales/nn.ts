export default {
    ...
    'inntektenDin.ingress': 'Kor mykje du kan få i omstillingsstønad er avhengig av arbeidsinntekta di. Vi bereknar ut forventa inntekt både på grunnlag av arbeidssituasjonen og inntekten din. Inntekt hentar vi frå Skatteetaten.',
