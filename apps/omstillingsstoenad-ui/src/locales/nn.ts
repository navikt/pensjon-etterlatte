export default {
    ...
    'inntektenDin.annenInntekt.tittel': 'Inga inntekt eller anna utbetaling ',
    'inntektenDin.annenInntekt.svar': 'Har du inntekt eller andre utbetalingar? ',
    'inntektenDin.annenInntekt.beloep': 'Oppgi beløp',
    'inntektenDin.annenInntekt.beskrivelse': 'Beskriv kva type utbetaling du får',
    'inntektenDin.inntektViaYtelserFraNAV.tittel': 'Ytingar frå NAV ',
    'inntektenDin.inntektViaYtelserFraNAV.inntektEllerUtbetaling': '<MANGLER TITTEL>',
    ...
    'feil.inntektViaYtelserFraNAV.inntektEllerUtbetaling.required': 'Kryss av for kva andre inntekter og utbetalingar du har',
    'feil.annenInntekt.svar.required': 'Oppgi om du har inntekt eller noen andre utbetalinger',
    'feil.annenInntekt.beloep.required': 'Oppgi beløp',
    'feil.annenInntekt.beskrivelse.required': 'Beskriv kva type utbetaling du får',
