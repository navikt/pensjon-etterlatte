export default {
    ...
    'inntektenDin.pensjonEllerUfoere.utland.beloep': 'Oppgi brutto månadsbeløp utbetalt i pensjon frå utlandet',
    ...
    'readmore.tittel.hvorfor.spoer.vi': 'Kvifor spør vi om dette?',
}
