export default {
    ...
    'inntektenDin.annenInntekt.tittel': 'No income or other payments',
    'inntektenDin.annenInntekt.svar': 'Do you have an income or other type of benefits?',
    'inntektenDin.annenInntekt.beloep': 'State the amount',
    'inntektenDin.annenInntekt.beskrivelse': 'Describe which types of payments you are receiving',
    'inntektenDin.inntektViaYtelserFraNAV.tittel': 'Benefits from NAV',
    'inntektenDin.inntektViaYtelserFraNAV.inntektEllerUtbetaling': 'Which other incomes or disbursements are you receiving?',
    'inntektenDin.inntektViaYtelserFraNAV.beloep': '<SKAL FJERNES>',
    ...
    'feil.inntektViaYtelserFraNAV.inntektEllerUtbetaling.required': 'Tick which other incomes or disbursements you receive',
    'feil.annenInntekt.svar.required': 'State if you have an income or other type of benefits',
    'feil.annenInntekt.beloep.required': 'State the amount',
    'feil.annenInntekt.beskrivelse.required': 'Describe which types of payments you are receiving',
