export default {
    ...
    'inntektenDin.annenInntekt.tittel': 'Other incomes or payments',
    'inntektenDin.annenInntekt.inntektEllerUtbetaling': 'Which other incomes or disbursements are you receiving?',
    'inntektenDin.annenInntekt.beloep': 'State gross income or benefits',
    'inntektenDin.annenInntekt.forventerEndringAvInntekt.svar':
        'Do you expect your income to change in the near future?',
    'inntektenDin.annenInntekt.forventerEndringAvInntekt.grunn': 'What is the reason for the change?',
    'inntektenDin.annenInntekt.forventerEndringAvInntekt.annenGrunn': 'Provide a brief description of the changes',
    ...
    'feil.annenInntekt.inntektEllerUtbetaling.required': 'Tick which other incomes or disbursements you receive',
    'feil.annenInntekt.beloep.required': 'State gross income or benefits',
    'feil.annenInntekt.forventerEndringAvInntekt.svar.required': 'Expectations about income must be answered',
    'feil.annenInntekt.forventerEndringAvInntekt.grunn.required': 'State the reason for the change',
    'feil.annenInntekt.forventerEndringAvInntekt.annenGrunn.required': 'Describe the changes must be answered',
