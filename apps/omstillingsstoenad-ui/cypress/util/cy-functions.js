export const gaaTilNesteSide = () => cy.get('[type="button"]').contains('Neste steg').click()
export const gaaTilbake = () => cy.get('[type="button"]').contains('Forrige steg').click()
...
export const basePath = '/omstillingsstonad/soknad'
