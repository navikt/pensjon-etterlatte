export default {
  ...
  "omBarn.soeknadOmTilleggsstoenadBarnepass.beskrivelse": "Du kan få dekket deler av utgiftene til pass av barn dersom du er gjenlevende ektefelle som gjennomfører nødvendig og hensiktsmessig utdanning godkjent av NAV, eller er registrert som reell arbeidssøker hos NAV og sender meldekort.",
