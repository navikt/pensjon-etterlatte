export default {
    ...
    "omDegOgAvdoed.avdoed.dato.etterNovember": "Because the deceased's time of death was after November 2023 you must apply for a ",
    "omDegOgAvdoed.avdoed.dato.etterNovember.link": "adjustment allowance.",
